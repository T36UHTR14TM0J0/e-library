            ...
            <div class="col-md-6">
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="judul" name="judul" 
                           ...
                           placeholder="Masukkan judul fasilitas" value="{{ old('judul') }}">
                    @error('judul')
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="icon" name="icon" 
                           ...
                           placeholder="Contoh: fas fa-info" value="{{ old('icon') }}">
                    @error('icon')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                ...
                <div class="form-group mb-3">
                  ...
                  <select id="warna" name="warna" class="form-select @error('warna') is-invalid @enderror">
                      ...
                      <option value="secondary" {{ old('warna') == 'secondary' ? 'selected' : '' }}>Abu-abu</option>
                      <option value="info" {{ old('warna') == 'info' ? 'selected' : '' }}>Biru</option>
                      ...
                      <option value="danger" {{ old('warna') == 'danger' ? 'selected' : '' }}>Merah</option>
                  </select>
                  @error('warna')
                    <div class="invalid-feedback">
                      {{ $message }}
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="number" id="min_kapasitas" name="min_kapasitas" 
                           ...
                           placeholder="Masukkan kapasitas minimum" value="{{ old('min_kapasitas') }}">
                    @error('min_kapasitas')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
            ...
            <div class="col-md-6">
                <div class="form-group mb-3">
                    ...
                    <input type="number" id="maks_kapasitas" name="maks_kapasitas" 
                           ...
                           placeholder="Masukkan kapasitas maksimum" value="{{ old('maks_kapasitas') }}">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="info" name="info" 
                           ...
                           placeholder="Masukkan info tambahan" value="{{ old('info') }}">
                    @error('info')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                    ...
                    @foreach(old('fasilitas') as $index => $fasilitas)
                        <div class="input-group mb-2">
                            <input type="text" name="fasilitas[]" class="form-control @error('fasilitas.'.$index) is-invalid @enderror" 
                                   placeholder="Masukkan fasilitas" value="{{ $fasilitas }}">
                            @if($loop->first)
                                <button class="btn btn-success" type="button" onclick="addFasilitasField()">
                                    <i class="bi bi-plus"></i>
                                </button>
                            @else
                                <button class="btn btn-danger" type="button" onclick="removeFasilitasField(this)">
