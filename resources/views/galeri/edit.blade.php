@extends('layouts.app')
@section('title', 'Edit Data Galeri Perpustakaan')
    ...
    <form method="POST" action="{{ route('galeri.update', $galeri->id) }}" enctype="multipart/form-data">
        ...
        <div class="form-group mb-3">
            ...
            <input type="number" id="urut" name="urut" class="form-control @error('urut') is-invalid @enderror" 
                   placeholder="Masukkan nomor urut" value="{{ old('urut', $galeri->urut) }}" min="1">
            @error('urut')
        ...
        <div class="form-group mb-3">
            ...
            @if($galeri->foto)
                <div class="mb-2">
                    <img src="{{ asset('storage/' . $galeri->foto) }}" alt="Preview" class="img-thumbnail" style="max-height: 200px;">
                </div>
            @endif
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" id="judul" name="judul" class="form-control @error('judul') is-invalid @enderror" 
                   placeholder="Masukkan judul galeri" value="{{ old('judul', $galeri->judul) }}">
            @error('judul')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
